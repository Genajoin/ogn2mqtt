...
class PrometheusMetrics {
  ...
  initializeMetrics() {
    ...
    this.messageProcessingDuration = new client.Histogram({
      name: 'ogn_message_processing_duration_seconds',
    ...
    this.filteredMessagesRate = new client.Gauge({
      name: 'ogn_filtered_messages_rate',
